...
import edu.mobile.project.platform.commom.log.Logs;
import edu.mobile.project.platform.commom.utils.*;
import edu.mobile.project.platform.dao.HibernateBaseDao;
...
public class HibernateBaseDaoImpl<T, PK extends Serializable> implements HibernateBaseDao<T, PK> {
    ...
    */
    ...
    public List<T> findAll(QueryParameterSetter paraSetter) {
        // TODO Auto-generated method stub
        DetachedCriteria dc = DetachedCriteria.forClass(entityClass);
        paraSetter.setParameters(dc);
        return findAll(dc);
    ...
    */
    ...
    public void findPageList(QueryParameterSetter paraSetter,
                             Page<T> page) {
        // TODO Auto-generated method stub
        DetachedCriteria dc = DetachedCriteria.forClass(entityClass);
        if (paraSetter != null)
    ...
    public void findPageList(Page<T> page) {
        // TODO Auto-generated method stub
        DetachedCriteria dc = DetachedCriteria.forClass(entityClass);
        findPageList(dc, page);
    }
    ...
    public void findPageList(String hqlQuery, Object[] objs, Page<T> page) {
        // TODO Auto-generated method stub
        Assert.hasText(hqlQuery, "hqlQuery不能为空");
    ...
    */
    ...
    public T findUnique(QueryParameterSetter paraSetter) {
        // TODO Auto-generated method stub
        DetachedCriteria dc = DetachedCriteria.forClass(entityClass);
        paraSetter.setParameters(dc);
